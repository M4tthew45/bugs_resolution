	...
	<div class="grid unix">
		<form action="" method="post"  class="form login">
			<div class="form__field santuario">
				...
				<input type="text" name="usuario" class="form__input" placeholder="Usuario"  minlength="4" onfocus="mensaje()" value="" required>
			</div>
			<div class="form__field">
				<label for="login__password">
					...
					<span class="hidden">Clave</span>
				</label>
				<input type="password" name="clave" class="form__input" placeholder="Contraseña" onfocus="mensaje()" value="" required>
			</div>
			<div class="form__field">
...
if(isset($_POST["usuario"]) && isset($_POST["clave"])){
	...
	include_once "roots/data.php";
	
	
	if($boolSession === 1){
		$_SESSION["unixLogin"] = "root";
